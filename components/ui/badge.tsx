  ...
  return (
    <div
      className={cn(
        ...
        variant === "warning" && "border-transparent bg-warning text-warning-foreground shadow hover:bg-warning/80",
        variant === "success" && "border-transparent bg-success text-success-foreground shadow hover:bg-success/80",
